...
# Set the watermark strategy with a bounded out-of-orderness tolerance of 10 seconds
watermark_strategy = WatermarkStrategy.for_bounded_out_of_orderness(Time.seconds(10))
